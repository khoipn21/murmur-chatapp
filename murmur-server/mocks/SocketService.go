...
// NewSocketService creates a new instance of SocketService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSocketService(t interface {
	mock.TestingT
	Cleanup(func())
}) *SocketService {
	mock := &SocketService{}
