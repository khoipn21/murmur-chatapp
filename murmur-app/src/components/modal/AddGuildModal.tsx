...
function AddGuildModal({ isOpen, onClose }: IProps) {
...
function JoinServerModal({ goBack, submitClose }: IScreenProps) {
...
function CreateServerModal({ goBack, submitClose }: IScreenProps) {
